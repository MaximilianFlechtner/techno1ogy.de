<template>
  <div class="dark:bg-gray-900 transition duration-500 ease-out">
    ...
    <div class="max-w-7xl mx-auto dark:text-gray-100 transition duration-500 ease-out">
      ...
      <p>
        Maximilian Flechtner<br />Leppiner Dorfstraße 60<br />39619 Arendsee
      </p>
      E-Mail-Adresse:
      <p>flechtner@techno1ogy.de</p>
      Telefon:
      <p>017641766223</p>
      <h2
        class="
      ...
      <ul class="m-elements">
        <li>
          <strong>Medium: </strong>Hostingplattform für Blogs / Websites;
          <strong>Dienstanbieter:</strong> A Medium Corporation, P.O. Box 602,
          San Francisco, CA 94104–0602, USA; <strong>Website:</strong>
          <a href="https://medium.com/" target="_blank">https://medium.com/</a>;
