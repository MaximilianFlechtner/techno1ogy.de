<template>
  <div class="max-w-7xl mx-auto lg:my-48 my-28 lg:px-0 px-6">
    <div
      class="
        md:masonry-2-col
        box-border
    ...
    >
      <div class="mb-10">
        ...
        <small class="dark:text-gray-100"
          >Perfekte Lösungen für digitale Präsenz.</small
        >
        <p class="dark:text-gray-100 mt-4">
          Ich realisiere Ihre Ideen und zauber daraus schöne, ansprechende,
          moderne und funktionale Apps und Webseiten. Lassen Sie sich von meinen
